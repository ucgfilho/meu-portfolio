...
type ResizeObserverRef = React.RefObject<HTMLElement | null>;

const useResizeObserver = (
  callback: () => void,
  elements: ResizeObserverRef[],
  ...
  ({
    ...
    const renderLogoItem = useCallback(
      (item: LogoItem, key: string) => {
        ...
        const itemAriaLabel = isNodeItem ? (item.ariaLabel ?? item.title) : ((item as ImageLogoItem).alt ?? item.title);
